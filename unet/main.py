...
def get_args():
    ...
    parser.add_argument('--patience2', type=int, default=5, help='Patience used by the scheduler to reduce the lr')
...
def main(args):
    ...
    # I decide to use the size 256x256 for UNet to have a manageable training time (it's more a matter of memory resources)
